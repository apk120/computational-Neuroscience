function [psth, psthtime]= fiber_response_speech(BF, signal, stim_db, n_rep)
CF    = BF; % CF in Hz;   
...
T  = (length(signal)+1)/Fs;  % stimulus duration in seconds
...
vihc = catmodel_IHC(signal , CF, nrep, 1/Fs, T,cohc,cihc); 
